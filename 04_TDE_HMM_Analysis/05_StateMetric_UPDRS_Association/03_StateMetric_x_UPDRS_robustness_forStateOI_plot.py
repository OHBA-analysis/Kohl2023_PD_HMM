...
Script to assess robustness of significant correlation between UPDRS and State Metric
scores.

Load GLM output from correlations between State Metrics and UPDRS scores for all
HMMs that were run (across States and runs) and make a big beeswarm plot of the
t-statistics of the correlation. 
...
outdir_plot = '/path/to/Results/StateMetrics_x_UPDRS/'
...
# --- Load T-Stats of State Metric x UPDRS score association for all HMM fits ---
    ...
    for emb in embeddings:
        for K_ind,K in enumerate(number_of_states):
            ...
            for irun in runs:
                            ...
                            indir_dat = proj_dir + 'Data/StateMetrics_x_UPDRS/ds' + \
...
# --- Plotting Tstatistics of Metric Group Contrast colored by Number of States ---
